<script type="text/javascript">
	document.getElementById('page_title').innerHTML = "Create Post";
</script>
		...
		<div class="page_data_block">
			<div class="post_creation_form">
				<div class="post_title_block">
					<input type="text" name="post_title" placeholder="Post Title" class="cp_post_title">
				</div>
				<div class="post_writer_block">
					<textarea name="post_content" id="body" style="display: none;"></textarea>
				</div>
			...
			<div class="p_action_area">
				...
				<div class="sidebar_option_list">
					...
					<div class="p_option_content" id="option_expander_p_status">
						<p class="post_now_status">Current Status <span class="post_now_status">Published</span></p>
				...
				<div class="sidebar_option_list">
					...
					<div class="p_option_content" id="option_expander_p_setting">
						<div class="p_opt_cont_block">
							<input type="checkbox" id="comments_available" name="comments_available" value="1" checked>
				...
				<div class="sidebar_option_list">
					...
					<div class="p_option_content" id="option_expander_p_tags">
						<div class="p_opt_cont_block">
							...
							<input type="text" name="p_tags" class="p_tags_input" onkeyup="write_tags_block()" id="p_tag_list" maxlength="1024">
